...
<head>
    ...
    <title>Contact Us - SMC Ltd</title>
  ...
  <br />
    ...
    <main>
        <section class="contact">
            <div class="container">
                <h2>Contact Us</h2>
                <p>If you have any questions or concerns, feel free to send us a message using the form below. We will get back to you as soon as possible.</p>
                ...
                <p>By submitting this form, you agree to our <a href="privacy-policy.php">Privacy Policy</a>.</p>
            </div>
        </section>
    </main>
